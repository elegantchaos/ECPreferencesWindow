...
# Preference Bundles
 ...
 Each of these bundles is then asked to provide a list of pane dictionaries for additional
 panes to load.
 
 # Timing

 The bundles folder is scanned when the controller is first created, and any preference
 bundles that are found get called at this point in order to set themselves up.
